...
function twentyeleven_setup() {
	...
	register_nav_menu( 'category', __( 'Category Menu', 'twentyeleven' ) );
...
function twentyeleven_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'адрес в шапке рус', 'twentyeleven' ),
		'id' => 'address-1',
		'before_widget' => '<div id="%1$s" class="widget-address %2$s">',
		'after_widget' => "</div>",
		'before_title' => '<div class="widget-title">',
		'after_title' => '</div>',
	) );
	register_sidebar( array(
		'name' => __( 'адрес в шапке укр', 'twentyeleven' ),
		'id' => 'address-2',
		'before_widget' => '<div id="%1$s" class="widget-address %2$s">',
		'after_widget' => "</div>",
		'before_title' => '<div class="widget-title">',
	...
	register_sidebar( array(
		'name' => __( 'адрес в шапке англ', 'twentyeleven' ),
		'id' => 'address-3',
		'before_widget' => '<div id="%1$s" class="widget-address %2$s">',
		'after_widget' => "</div>",
		'before_title' => '<div class="widget-title">',
	...
	register_sidebar( array(
		'name' => __( 'телефон в футере', 'twentyeleven' ),
		'id' => 'phone-2',
	...
	register_sidebar( array(
		'name' => __( 'телефон на главную', 'twentyeleven' ),
		'id' => 'phone-m',
		'before_widget' => '<div id="%1$s" class="widget-phone-m %2$s">',
		'after_widget' => "</div>",
		'before_title' => '<div class="widget-title">',
		'after_title' => '</div>',
	) );
...
function my_custom_post_clients() {
    $labels = array(
        'name'               => _x( 'Все Клиенты', 'post type general name' ),
        'singular_name'      => _x( 'Клиенты', 'post type singular name' ),
        'add_new'            => _x( 'Добавить новый', 'new' ),
        'add_new_item'       => __( 'Добавить новое Клиенты' ),
        'edit_item'          => __( 'Редактировать Клиенты' ),
        'new_item'           => __( 'Новое Клиенты' ),
        'all_items'          => __( 'Все Клиенты' ),
        'view_item'          => __( 'Просмотр строительства' ),
        'search_items'       => __( 'Поиск строительства' ),
        'not_found'          => __( 'Клиенты не найдено' ),
        'not_found_in_trash' => __( 'Клиенты не найдено в Корзине' ), 
        'parent_item_colon'  => '',
        'menu_name'          => 'Все Клиенты'
    );
    $args = array(
        'labels'        => $labels,
...
function my_taxonomies_clients() {
    $labels = array(
        'name'              => _x( 'Категории Клиенты', 'taxonomy general name' ),
        'singular_name'     => _x( 'Категория Клиенты', 'taxonomy singular name' ),
        'search_items'      => __( 'Поиск' ),
        'all_items'         => __( 'Все категории Клиенты' ),
        'parent_item'       => __( '' ),
        ...
        'menu_name'         => __( 'Категории Клиенты' ),
    );
    $args = array(
        'labels' => $labels,
        'hierarchical' => true,
    );
    register_taxonomy( 'all-clients', 'clients', $args );
}
add_action( 'init', 'my_taxonomies_clients', 0 );
/*********************************************************/
function my_custom_post_news() {
    $labels = array(
        'name'               => _x( 'Все Новости', 'post type general name' ),
        'singular_name'      => _x( 'Новости', 'post type singular name' ),
        'add_new'            => _x( 'Добавить новый', 'new' ),
        'add_new_item'       => __( 'Добавить новое Новости' ),
        'edit_item'          => __( 'Редактировать Новости' ),
        'new_item'           => __( 'Новое Новости' ),
        'all_items'          => __( 'Все Новости' ),
        'view_item'          => __( 'Просмотр строительства' ),
        'search_items'       => __( 'Поиск строительства' ),
        'not_found'          => __( 'Новости не найдено' ),
        'not_found_in_trash' => __( 'Новости не найдено в Корзине' ), 
        'parent_item_colon'  => '',
        'menu_name'          => 'Все Новости'
    );
    $args = array(
        'labels'        => $labels,
        'description'   => 'Holds our products and product specific data',
...
function my_taxonomies_news() {
    $labels = array(
        'name'              => _x( 'Категории Новости', 'taxonomy general name' ),
        'singular_name'     => _x( 'Категория Новости', 'taxonomy singular name' ),
        'search_items'      => __( 'Поиск' ),
        'all_items'         => __( 'Все категории Новости' ),
        'parent_item'       => __( '' ),
        'parent_item_colon' => __( '' ),
        'edit_item'         => __( 'Изменить' ), 
        'update_item'       => __( 'Обновить' ),
        'add_new_item'      => __( 'Добавить новую' ),
        'new_item_name'     => __( 'Новая' ),
        'menu_name'         => __( 'Категории Новости' ),
    );
    $args = array(
        'labels' => $labels,
        'hierarchical' => true,
    );
    register_taxonomy( 'all-news', 'news', $args );
}
add_action( 'init', 'my_taxonomies_news', 0 );
/*********************************************************/
function my_custom_post_office() {
    $labels = array(
        'name'               => _x( 'Все Офисы', 'post type general name' ),
        'singular_name'      => _x( 'Офисы', 'post type singular name' ),
        'add_new'            => _x( 'Добавить новый', 'new' ),
        'add_new_item'       => __( 'Добавить новое Офисы' ),
        'edit_item'          => __( 'Редактировать Офисы' ),
        'new_item'           => __( 'Новое Офисы' ),
        'all_items'          => __( 'Все Офисы' ),
        'view_item'          => __( 'Просмотр строительства' ),
        'search_items'       => __( 'Поиск строительства' ),
        'not_found'          => __( 'Офисы не найдено' ),
        'not_found_in_trash' => __( 'Офисы не найдено в Корзине' ), 
        'parent_item_colon'  => '',
        'menu_name'          => 'Все Офисы'
    );
    $args = array(
...
add_action( 'init', 'my_custom_post_office' );
function my_taxonomies_office() {
    $labels = array(
        'name'              => _x( 'Категории Офисы', 'taxonomy general name' ),
        'singular_name'     => _x( 'Категория Офисы', 'taxonomy singular name' ),
        'search_items'      => __( 'Поиск' ),
        'all_items'         => __( 'Все категории Офисы' ),
        'parent_item'       => __( '' ),
        'parent_item_colon' => __( '' ),
        'edit_item'         => __( 'Изменить' ), 
        'update_item'       => __( 'Обновить' ),
        'add_new_item'      => __( 'Добавить новую' ),
        'new_item_name'     => __( 'Новая' ),
        'menu_name'         => __( 'Категории Офисы' ),
    );
    $args = array(
        'labels' => $labels,
        'hierarchical' => true,
    );
    register_taxonomy( 'all-office', 'office', $args );
}
add_action( 'init', 'my_taxonomies_office', 0 );
/*********************************************************/
function my_custom_post_proj() {
    $labels = array(
        'name'               => _x( 'Все Проектирование', 'post type general name' ),
        'singular_name'      => _x( 'Проектирование', 'post type singular name' ),
        'add_new'            => _x( 'Добавить новый', 'new' ),
        'add_new_item'       => __( 'Добавить новое Проектирование' ),
        'edit_item'          => __( 'Редактировать Проектирование' ),
        'new_item'           => __( 'Новое Проектирование' ),
        'all_items'          => __( 'Все Проектирование' ),
        'view_item'          => __( 'Просмотр строительства' ),
        'search_items'       => __( 'Поиск строительства' ),
        'not_found'          => __( 'Проектирование не найдено' ),
        'not_found_in_trash' => __( 'Проектирование не найдено в Корзине' ), 
        'parent_item_colon'  => '',
        'menu_name'          => 'Все Проектирование'
    );
    $args = array(
        'labels'        => $labels,
        'description'   => 'Holds our products and product specific data',
...
add_action( 'init', 'my_custom_post_proj' );
function my_taxonomies_proj() {
    $labels = array(
        'name'              => _x( 'Категории Проектирование', 'taxonomy general name' ),
        'singular_name'     => _x( 'Категория Проектирование', 'taxonomy singular name' ),
        'search_items'      => __( 'Поиск' ),
        'all_items'         => __( 'Все категории Проектирование' ),
        'parent_item'       => __( '' ),
        'parent_item_colon' => __( '' ),
        'edit_item'         => __( 'Изменить' ), 
        'update_item'       => __( 'Обновить' ),
        'add_new_item'      => __( 'Добавить новую' ),
        'new_item_name'     => __( 'Новая' ),
        'menu_name'         => __( 'Категории Проектирование' ),
    );
    $args = array(
        'labels' => $labels,
        'hierarchical' => true,
    );
    register_taxonomy( 'all-proj', 'proj', $args );
}
add_action( 'init', 'my_taxonomies_proj', 0 );
/*********************************************************/
